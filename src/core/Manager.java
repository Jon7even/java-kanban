...
Помогло следующее - я скопировал весь в код в текстовый редактор, удалил файл, создал заново и снова его внес.
Но перед этим около 3 часов пробовал все подряд, даже откатывал коммит и угробил проект свой),
пробовал то что на Стаке писали, не помогло.
*/
package core;
import tasks.*;
